# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_ota.c"
...
__extension__ _Static_assert(51463 < 65535, "Assert at line __LINE__");
...
# 45 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_ota.c" 2
...
{
  do { if ((zb_int_t)0>=(zb_int_t)2 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 2, 51463,74, (0*4 + 1*4 + 1*4 + 1*4 + 0*8), dev, offset, size); } while (0);
...
void zb_osif_ota_write(void *dev, zb_uint8_t *data, zb_uint_t off, zb_uint_t size, zb_uint32_t image_size)
{
  (void)image_size;
  (void)data;
  do { if ((zb_int_t)0>=(zb_int_t)2 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 2, 51463,82, (0*4 + 1*4 + 1*4 + 1*4 + 0*8), dev, off, size); } while (0);

}

void zb_osif_ota_mark_fw_ready(void *dev, zb_uint32_t size, zb_uint32_t revision)
{
  do { if ((zb_int_t)0>=(zb_int_t)1 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 1, 51463,89, (0*4 + 0*4 + 2*4 + 1*4 + 0*8), dev, size, revision); } while (0)
                                              ;
...
{
  do { if ((zb_int_t)0>=(zb_int_t)2 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 2, 51463,95, (0*4 + 0*4 + 0*4 + 0*4 + 0*8)); } while (0);
...
{
  do { if ((zb_int_t)0>=(zb_int_t)2 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 2, 51463,102, (0*4 + 0*4 + 0*4 + 0*4 + 0*8)); } while (0);

}

void zb_osif_ota_close_storage(void *dev)
{
  do { if ((zb_int_t)0>=(zb_int_t)2 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 2, 51463,108, (0*4 + 0*4 + 0*4 + 1*4 + 0*8), dev); } while (0);

}
# 119 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_ota.c"
 zb_void_t __attribute__ ((weak)) zb_osif_ota_verify_integrity_done(zb_uint8_t integrity_is_ok)
{
 (void)integrity_is_ok;
}
...
zb_void_t zb_sec_b6_hash_iter_done(void *dev, zb_uint32_t input_len, zb_uint8_t *calc_hash)
{
  ...
  (void)input_len;
  (void)calc_hash;
  do { if ((zb_int_t)0>=(zb_int_t)2 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 2, 51463,131, (0*4 + 0*4 + 0*4 + 0*4 + 0*8)); } while (0);

  zb_err_code = zb_schedule_callback(zb_osif_ota_verify_integrity_done, ZB_TRUE, ZB_FALSE, 0, ZB_FALSE);
  (void)zb_err_code;
}
...
{
  (void)dev;
  do { if ((zb_int_t)0>=(zb_int_t)2 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 2, 51463,141, (0*4 + 0*4 + 1*4 + 0*4 + 0*8), raw_len - (2 + 4 + 16 )); } while (0)
                                                          ;
...
void zb_osif_ota_read(void *dev, zb_uint8_t *data, zb_uint32_t addr, zb_uint32_t size)
{
  do { if ((zb_int_t)0>=(zb_int_t)2 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 2, 51463,149, (0*4 + 0*4 + 2*4 + 2*4 + 0*8), dev, data, addr, size); } while (0)
                                                  ;
