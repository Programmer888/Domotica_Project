# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\zb_error\\zb_error_to_string.c"
...
# 48 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\zb_error\\zb_error_to_string.c" 2


# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\zb_error\\zb_error_to_string.h" 1
# 50 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\zb_error\\zb_error_to_string.h"
...
# 47 "../../../../../../../../external/zboss/include/osif/zb_osif_nrf52840.h"
# 1 "../../../../../../../../external/zboss/include/zb_types.h" 1
...
# 51 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\zb_error\\zb_error_to_string.h" 2
# 1 "../../../../../../../../external/zboss/include/zb_errors.h" 1
# 52 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\zb_error\\zb_error_to_string.h" 2
# 70 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\zb_error\\zb_error_to_string.h"
...
{
    {.code = -RET_OK, .name = "RET_OK"},
    {.code = -RET_ERROR, .name = "RET_ERROR"},
    {.code = -RET_BLOCKED, .name = "RET_BLOCKED"},
    {.code = -RET_EXIT, .name = "RET_EXIT"},
    {.code = -RET_BUSY, .name = "RET_BUSY"},
    {.code = -RET_EOF, .name = "RET_EOF"},
    {.code = -RET_OUT_OF_RANGE, .name = "RET_OUT_OF_RANGE"},
    {.code = -RET_EMPTY, .name = "RET_EMPTY"},
    {.code = -RET_CANCELLED, .name = "RET_CANCELLED"},

    {.code = -RET_INVALID_PARAMETER_1, .name = "RET_INVALID_PARAMETER_1"},
    {.code = -RET_INVALID_PARAMETER_2, .name = "RET_INVALID_PARAMETER_2"},
    {.code = -RET_INVALID_PARAMETER_3, .name = "RET_INVALID_PARAMETER_3"},
    {.code = -RET_INVALID_PARAMETER_4, .name = "RET_INVALID_PARAMETER_4"},
    {.code = -RET_INVALID_PARAMETER_5, .name = "RET_INVALID_PARAMETER_5"},
    {.code = -RET_INVALID_PARAMETER_6, .name = "RET_INVALID_PARAMETER_6"},
    {.code = -RET_INVALID_PARAMETER_7, .name = "RET_INVALID_PARAMETER_7"},
    {.code = -RET_INVALID_PARAMETER_8, .name = "RET_INVALID_PARAMETER_8"},
    {.code = -RET_INVALID_PARAMETER_9, .name = "RET_INVALID_PARAMETER_9"},
    {.code = -RET_INVALID_PARAMETER_10, .name = "RET_INVALID_PARAMETER_10"},
    {.code = -RET_INVALID_PARAMETER_11_OR_MORE, .name = "RET_INVALID_PARAMETER_11_OR_MORE"},
    {.code = -RET_PENDING, .name = "RET_PENDING"},
    {.code = -RET_NO_MEMORY, .name = "RET_NO_MEMORY"},
    {.code = -RET_INVALID_PARAMETER, .name = "RET_INVALID_PARAMETER"},
    {.code = -RET_OPERATION_FAILED, .name = "RET_OPERATION_FAILED"},
    {.code = -RET_BUFFER_TOO_SMALL, .name = "RET_BUFFER_TOO_SMALL"},
    {.code = -RET_END_OF_LIST, .name = "RET_END_OF_LIST"},
    {.code = -RET_ALREADY_EXISTS, .name = "RET_ALREADY_EXISTS"},
    {.code = -RET_NOT_FOUND, .name = "RET_NOT_FOUND"},
    {.code = -RET_OVERFLOW, .name = "RET_OVERFLOW"},
    {.code = -RET_TIMEOUT, .name = "RET_TIMEOUT"},
    {.code = -RET_NOT_IMPLEMENTED, .name = "RET_NOT_IMPLEMENTED"},
    {.code = -RET_NO_RESOURCES, .name = "RET_NO_RESOURCES"},
    {.code = -RET_UNINITIALIZED, .name = "RET_UNINITIALIZED"},
    {.code = -RET_NO_SERVER, .name = "RET_NO_SERVER"},
    {.code = -RET_INVALID_STATE, .name = "RET_INVALID_STATE"},
    {.code = -RET_DOES_NOT_EXIST, .name = "RET_DOES_NOT_EXIST"},
    {.code = -RET_CONNECTION_FAILED, .name = "RET_CONNECTION_FAILED"},
    {.code = -RET_CONNECTION_LOST, .name = "RET_CONNECTION_LOST"},
    {.code = -RET_CANCELLED_BY_USER, .name = "RET_CANCELLED_BY_USER"},
    {.code = -RET_UNAUTHORIZED, .name = "RET_UNAUTHORIZED"},
    {.code = -RET_CONFLICT, .name = "RET_CONFLICT"},
    {.code = -RET_COULD_NOT_OPEN_FILE, .name = "RET_COULD_NOT_OPEN_FILE"},
    {.code = -RET_NO_MATCH, .name = "RET_NO_MATCH"},
    {.code = -RET_PROTOCOL_ERROR, .name = "RET_PROTOCOL_ERROR"},
    {.code = -RET_VERSION, .name = "RET_VERSION"},
    {.code = -RET_MALFORMED_ADDRESS, .name = "RET_MALFORMED_ADDRESS"},
    {.code = -RET_COULD_NOT_READ_FILE, .name = "RET_COULD_NOT_READ_FILE"},
    {.code = -RET_FILE_NOT_FOUND, .name = "RET_FILE_NOT_FOUND"},
    {.code = -RET_DIRECTORY_NOT_FOUND, .name = "RET_DIRECTORY_NOT_FOUND"},
    {.code = -RET_CONVERSION_ERROR, .name = "RET_CONVERSION_ERROR"},
    {.code = -RET_INCOMPATIBLE_TYPES, .name = "RET_INCOMPATIBLE_TYPES"},
    {.code = -RET_INCOMPATIBLE_TYPES_IN_COMPARE, .name = "RET_INCOMPATIBLE_TYPES_IN_COMPARE"},
    {.code = -RET_INCOMPATIBLE_TYPES_IN_ASSIGNMENT, .name = "RET_INCOMPATIBLE_TYPES_IN_ASSIGNMENT"},
    {.code = -RET_INCOMPATIBLE_TYPES_IN_EXPRESSION, .name = "RET_INCOMPATIBLE_TYPES_IN_EXPRESSION"},
    {.code = -RET_ILLEGAL_COMPARE_OPERATION, .name = "RET_ILLEGAL_COMPARE_OPERATION"},
    {.code = -RET_FILE_CORRUPTED, .name = "RET_FILE_CORRUPTED"},
    {.code = -RET_PAGE_NOT_FOUND, .name = "RET_PAGE_NOT_FOUND"},
    {.code = -RET_FILE_WRITE_ERROR, .name = "RET_FILE_WRITE_ERROR"},
    {.code = -RET_FILE_READ_ERROR, .name = "RET_FILE_READ_ERROR"},
    {.code = -RET_FILE_PARTIAL_WRITE, .name = "RET_FILE_PARTIAL_WRITE"},
    {.code = -RET_TOO_MANY_OPEN_FILES, .name = "RET_TOO_MANY_OPEN_FILES"},
    {.code = -RET_ILLEGAL_REQUEST, .name = "RET_ILLEGAL_REQUEST"},
    {.code = -RET_INVALID_BINDING, .name = "RET_INVALID_BINDING"},
    {.code = -RET_INVALID_GROUP, .name = "RET_INVALID_GROUP"},
    {.code = -RET_TABLE_FULL, .name = "RET_TABLE_FULL"},
    {.code = -RET_NO_ACK, .name = "RET_NO_ACK"},
    {.code = -RET_ACK_OK, .name = "RET_ACK_OK"},
    {.code = -RET_NO_BOUND_DEVICE, .name = "RET_NO_BOUND_DEVICE"},
    {.code = -RET_IGNORE, .name = "RET_IGNORE"},
    {.code = -RET_AGAIN, .name = "RET_AGAIN"},
    {.code = -RET_DEVICE_NOT_FOUND, .name = "RET_DEVICE_NOT_FOUND"}
};
...
char const * zb_error_to_string_get(zb_ret_t code)
{
    ...
    return (p_ret == 
# 162 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\zb_error\\zb_error_to_string.c" 3 4
                    0
# 162 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\zb_error\\zb_error_to_string.c"
                        ) ? m_unknown_str : p_ret;
}
...
char const * zb_error_to_string_find(zb_ret_t code)
{
    ...
    p_end = zb_strerror_array + (sizeof(zb_strerror_array) / sizeof((zb_strerror_array)[0]));
