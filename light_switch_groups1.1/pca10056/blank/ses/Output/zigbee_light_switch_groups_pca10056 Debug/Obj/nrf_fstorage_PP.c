# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\fstorage\\nrf_fstorage.c"
...
# 53 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\fstorage\\nrf_fstorage.c" 2
const nrf_log_module_const_data_t m_nrf_log_nrf_fstorage_logs_data_const __attribute__ ((section("." "log_const_data_nrf_fstorage"))) __attribute__((used)) = { .p_module_name = "nrf_fstorage", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(3), .initial_lvl = (nrf_log_severity_t)(3), }; nrf_log_module_dynamic_data_t m_nrf_log_nrf_fstorage_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_nrf_fstorage"))) __attribute__((used)); nrf_log_module_filter_data_t m_nrf_log_nrf_fstorage_logs_data_filter __attribute__ ((section("." "log_filter_data_nrf_fstorage"))) __attribute__((used));
