# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\queue\\nrf_queue.c"
...
# 153 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\queue\\nrf_queue.c"
    ...
    if (!is_full || (p_queue->mode == NRF_QUEUE_MODE_OVERFLOW))
    {
        ...
        if (is_full)
        {
            ...
            if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if ((p_queue->p_log)->filter >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_WARNING) | (((uint32_t)(p_queue->p_log) - (uint32_t)&__start_log_dynamic_data) / sizeof(nrf_log_module_dynamic_data_t)) << 16), "Queue full. Overwriting oldest element."); } };
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if ((p_queue->p_log)->filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(p_queue->p_log) - (uint32_t)&__start_log_dynamic_data) / sizeof(nrf_log_module_dynamic_data_t)) << 16), "pushed element 0x%08X, status:%d", (uint32_t)(p_element), (uint32_t)(status)); } };
    return status;
}
...
# 220 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\queue\\nrf_queue.c"
    ...
    app_util_critical_region_exit(0);
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if ((p_queue->p_log)->filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(p_queue->p_log) - (uint32_t)&__start_log_dynamic_data) / sizeof(nrf_log_module_dynamic_data_t)) << 16), "%s element 0x%08X, status:%d", (uint32_t)(just_peek ? "peeked" : "popped"), (uint32_t)(p_element), (uint32_t)(status)); } }
                                                                                            ;
    return status;
}
# 277 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\queue\\nrf_queue.c"
...
# 336 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\queue\\nrf_queue.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if ((p_queue->p_log)->filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(p_queue->p_log) - (uint32_t)&__start_log_dynamic_data) / sizeof(nrf_log_module_dynamic_data_t)) << 16), "Write %d elements (start address: 0x%08X), status:%d", (uint32_t)(element_count), (uint32_t)(p_data), (uint32_t)(status)); } }
                                                                     ;
    return status;
}
...
# 370 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\queue\\nrf_queue.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if ((p_queue->p_log)->filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(p_queue->p_log) - (uint32_t)&__start_log_dynamic_data) / sizeof(nrf_log_module_dynamic_data_t)) << 16), "Put in %d elements (start address: 0x%08X), requested :%d", (uint32_t)(element_count), (uint32_t)(p_data), (uint32_t)(req_element_count)); } }
                                                                                ;
...
# 447 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\queue\\nrf_queue.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if ((p_queue->p_log)->filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(p_queue->p_log) - (uint32_t)&__start_log_dynamic_data) / sizeof(nrf_log_module_dynamic_data_t)) << 16), "Read %d elements (start address: 0x%08X), status :%d", (uint32_t)(element_count), (uint32_t)(p_data), (uint32_t)(status)); } }
                                                                     ;
    return status;
}
...
# 479 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\queue\\nrf_queue.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if ((p_queue->p_log)->filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(p_queue->p_log) - (uint32_t)&__start_log_dynamic_data) / sizeof(nrf_log_module_dynamic_data_t)) << 16), "Out %d elements (start address: 0x%08X), requested :%d", (uint32_t)(element_count), (uint32_t)(p_data), (uint32_t)(req_element_count)); } }
                                                                                ;
    return element_count;
}
...
# 497 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\queue\\nrf_queue.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if ((p_queue->p_log)->filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(p_queue->p_log) - (uint32_t)&__start_log_dynamic_data) / sizeof(nrf_log_module_dynamic_data_t)) << 16), "Reset"); } };
}
