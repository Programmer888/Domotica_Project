...
# 423 "../../../../../../../../modules/nrfx/hal/nrf_timer.h"
...
static inline 
# 541 "../../../../../../../../modules/nrfx/hal/nrf_timer.h" 3 4
               _Bool 
# 541 "../../../../../../../../modules/nrfx/hal/nrf_timer.h"
                    nrf_timer_event_check(NRF_TIMER_Type * p_reg,
                                           nrf_timer_event_t event)
{
    return (
# 544 "../../../../../../../../modules/nrfx/hal/nrf_timer.h" 3 4
           _Bool
# 544 "../../../../../../../../modules/nrfx/hal/nrf_timer.h"
...
static inline 
# 577 "../../../../../../../../modules/nrfx/hal/nrf_timer.h" 3 4
               _Bool 
# 577 "../../../../../../../../modules/nrfx/hal/nrf_timer.h"
                    nrf_timer_int_enable_check(NRF_TIMER_Type * p_reg,
                                                uint32_t timer_int)
{
    return (
# 580 "../../../../../../../../modules/nrfx/hal/nrf_timer.h" 3 4
           _Bool
# 580 "../../../../../../../../modules/nrfx/hal/nrf_timer.h"
               )(p_reg->INTENSET & timer_int);
}
# 613 "../../../../../../../../modules/nrfx/hal/nrf_timer.h"
static inline void nrf_timer_mode_set(NRF_TIMER_Type * p_reg,
                                        nrf_timer_mode_t mode)
{
                                               ...
                                               nrf_timer_frequency_t frequency)
{
    ...
    if (1) { if (ticks <= 
# 689 "../../../../../../../../modules/nrfx/hal/nrf_timer.h" 3 4
   4294967295UL
# 689 "../../../../../../../../modules/nrfx/hal/nrf_timer.h"
   ) { } else { assert_nrf_callback((uint16_t)689, (uint8_t *)"../../../../../../../../modules/nrfx/hal/nrf_timer.h"); } };
                                               ...
                                               nrf_timer_frequency_t frequency)
{
    ...
    if (1) { if (ticks <= 
# 700 "../../../../../../../../modules/nrfx/hal/nrf_timer.h" 3 4
   4294967295UL
# 700 "../../../../../../../../modules/nrfx/hal/nrf_timer.h"
   ) { } else { assert_nrf_callback((uint16_t)700, (uint8_t *)"../../../../../../../../modules/nrfx/hal/nrf_timer.h"); } };
    return (uint32_t)ticks;
}
...
enum {
# 89 "../../../../../../../../modules/nrfx/drivers/include/nrfx_timer.h"
...
extern nrf_log_module_dynamic_data_t m_nrf_log_TIMER_logs_data_dynamic;
extern const nrf_log_module_const_data_t m_nrf_log_TIMER_logs_data_const;
...
const nrf_log_module_const_data_t m_nrf_log_TIMER_logs_data_const __attribute__ ((section("." "log_const_data_TIMER"))) __attribute__((used)) = { .p_module_name = "TIMER", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_dynamic_data_t m_nrf_log_TIMER_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_TIMER"))) __attribute__((used)); nrf_log_module_filter_data_t m_nrf_log_TIMER_logs_data_filter __attribute__ ((section("." "log_filter_data_TIMER"))) __attribute__((used));
# 55 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_timer.c" 2
                           ...
                           nrfx_timer_event_handler_t timer_event_handler)
{
    ...
    {
        err_code = ((0x0) + 8);
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (m_nrf_log_TIMER_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | (((uint32_t)(&m_nrf_log_TIMER_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
...
# 95 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"
    ...
    err_code = ((0x0) + 0);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_TIMER_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_TIMER_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
...
# 132 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_timer.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_TIMER_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_TIMER_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Uninitialized instance: %d.", (uint32_t)(p_instance->instance_id)); } };
}
...
void nrfx_timer_enable(nrfx_timer_t const * const p_instance)
{
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_TIMER_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_TIMER_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Enabled instance: %d.", (uint32_t)(p_instance->instance_id)); } };
}
...
void nrfx_timer_disable(nrfx_timer_t const * const p_instance)
{
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_TIMER_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_TIMER_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Disabled instance: %d.", (uint32_t)(p_instance->instance_id)); } };
}
...
void nrfx_timer_resume(nrfx_timer_t const * const p_instance)
{
    ...
    nrf_timer_task_trigger(p_instance->p_reg, NRF_TIMER_TASK_START);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_TIMER_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_TIMER_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Resumed instance: %d.", (uint32_t)(p_instance->instance_id)); } };
}
...
void nrfx_timer_pause(nrfx_timer_t const * const p_instance)
{
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_TIMER_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_TIMER_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Paused instance: %d.", (uint32_t)(p_instance->instance_id)); } };
}
                                                  ...
                                                  enable_int)
{
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_TIMER_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_TIMER_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Timer id: %d, capture value set: %lu, channel: %d.", (uint32_t)(p_instance->instance_id), (uint32_t)(cc_value), (uint32_t)(cc_channel)); } }
                        ...
                        uint8_t channel_count)
{
    ...
    for (i = 0; i < channel_count; ++i)
    {
            ...
            nrf_timer_int_enable_check(p_reg, int_mask))
        {
            ...
            if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (m_nrf_log_TIMER_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(&m_nrf_log_TIMER_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Compare event, channel: %d.", (uint32_t)(i)); } };
