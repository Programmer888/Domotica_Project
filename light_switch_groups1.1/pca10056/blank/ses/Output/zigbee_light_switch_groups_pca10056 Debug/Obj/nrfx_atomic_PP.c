...
static inline 
# 285 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\soc\\nrfx_atomic_internal.h" 3 4
             _Bool 
# 285 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\soc\\nrfx_atomic_internal.h"
                  nrfx_atomic_internal_cmp_exch(nrfx_atomic_u32_t * p_data,
                                                uint32_t * p_expected,
                                                uint32_t value)
{
...
uint32_t nrfx_atomic_u32_fetch_store(nrfx_atomic_u32_t * p_data, uint32_t value)
{
    ...
    uint32_t old_val;
    uint32_t new_val;
    { uint32_t tmp_reg; __asm volatile( "1:     ldrex   %[""old_val""], [%[""p_data""]]\n" "mov %[""new_val""], %[""value""]\n" "       strex   %[tmp_reg], %[""new_val""], [%[""p_data""]]\n" "       teq     %[tmp_reg], #0\n" "       bne.n     1b" : [old_val] "=&r" (old_val), [new_val] "=&r" (new_val), [tmp_reg] "=&r" (tmp_reg) : [p_data] "r" (p_data), [value] "r" (value) : "cc"); (void)tmp_reg; };
    (void) new_val;
    return old_val;
