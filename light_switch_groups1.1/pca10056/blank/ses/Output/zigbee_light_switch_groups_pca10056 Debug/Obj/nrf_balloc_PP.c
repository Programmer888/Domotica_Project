# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\balloc\\nrf_balloc.c"
...
# 274 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\balloc\\nrf_balloc.c"
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if ((p_pool->p_log)->filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_3(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(p_pool->p_log) - (uint32_t)&__start_log_dynamic_data) / sizeof(nrf_log_module_dynamic_data_t)) << 16), "Initialized (size: %u x %u = %u bytes)", (uint32_t)(pool_size), (uint32_t)(p_pool->block_size), (uint32_t)(pool_size * p_pool->block_size)); } }
...
# 320 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\balloc\\nrf_balloc.c"
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if ((p_pool->p_log)->filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(p_pool->p_log) - (uint32_t)&__start_log_dynamic_data) / sizeof(nrf_log_module_dynamic_data_t)) << 16), "Allocating element: 0x%08X", (uint32_t)(p_block)); } };
...
# 328 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\balloc\\nrf_balloc.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if ((p_pool->p_log)->filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(p_pool->p_log) - (uint32_t)&__start_log_dynamic_data) / sizeof(nrf_log_module_dynamic_data_t)) << 16), "Freeing element: 0x%08X", (uint32_t)(p_element)); } };
# 359 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\balloc\\nrf_balloc.c"
