...
extern nrf_log_module_dynamic_data_t m_nrf_log_PRS_logs_data_dynamic;
extern const nrf_log_module_const_data_t m_nrf_log_PRS_logs_data_const;
...
const nrf_log_module_const_data_t m_nrf_log_PRS_logs_data_const __attribute__ ((section("." "log_const_data_PRS"))) __attribute__((used)) = { .p_module_name = "PRS", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_dynamic_data_t m_nrf_log_PRS_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_PRS"))) __attribute__((used)); nrf_log_module_filter_data_t m_nrf_log_PRS_logs_data_filter __attribute__ ((section("." "log_filter_data_PRS"))) __attribute__((used));
# 48 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c" 2
...
# 136 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\prs\\nrfx_prs.c"
        ...
        {
            ret_code = ((0x0) + 17);
            if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (m_nrf_log_PRS_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | (((uint32_t)(&m_nrf_log_PRS_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(ret_code))); } };
            return ret_code;
        }
    }

    ret_code = ((0x0) + 0);
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_PRS_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_PRS_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(ret_code))); } };
    return ret_code;
}
