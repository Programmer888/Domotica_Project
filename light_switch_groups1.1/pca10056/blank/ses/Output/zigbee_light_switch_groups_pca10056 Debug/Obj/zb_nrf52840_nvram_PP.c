# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
...
__extension__ _Static_assert(51401 < 65535, "Assert at line __LINE__");
...
# 44 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c" 2
...
# 62 "../../../../../../../../components/libraries/fstorage/nrf_fstorage.h"
# 1 "../../../../../../../../components/libraries/experimental_section_vars/nrf_section.h" 1
# 63 "../../../../../../../../components/libraries/fstorage/nrf_fstorage.h" 2
...
# 1 "../../../../../../../../components/libraries/fstorage/nrf_fstorage_nvmc.h" 1
# 54 "../../../../../../../../components/libraries/fstorage/nrf_fstorage_nvmc.h"
# 1 "../../../../../../../../components/libraries/fstorage/nrf_fstorage.h" 1
# 55 "../../../../../../../../components/libraries/fstorage/nrf_fstorage_nvmc.h" 2
# 67 "../../../../../../../../components/libraries/fstorage/nrf_fstorage_nvmc.h"
...
{
  {if(!(p_evt->result == 
# 97 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c" 3
 ((0x0) + 0)
# 97 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
 )) zb_assert(51401, 97);};
  {
    switch (p_evt->id)
    {
      ...
      case NRF_FSTORAGE_EVT_ERASE_RESULT:
        ...
        break;
      default:
        {if(!(0)) zb_assert(51401, 107);};
        break;
    }
  }
}

nrf_fstorage_t nvram_fstorage __attribute__ ((section("." "fs_data"))) __attribute__((used)) =
{
...
{
    uint32_t const bootloader_addr = 
# 131 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c" 3
                                    (((NRF_UICR_Type*) 0x10001000UL)->NRFFW[0])
# 131 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
                                                      ;
    uint32_t const page_sz = 
# 132 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c" 3
                                    ((NRF_FICR_Type*) 0x10000000UL)
# 132 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
                                            ->CODEPAGESIZE;
    uint32_t const code_sz = 
# 133 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c" 3
                                    ((NRF_FICR_Type*) 0x10000000UL)
# 133 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
                                            ->CODESIZE;
...
# 166 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c" 3 4
   0
...
# 168 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
 err_code 
# 168 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c" 3
 == ((0x0) + 0)) { } else { assert_nrf_callback((uint16_t)168, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"); } }
# 168 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
                        ;
}
...
zb_ret_t zb_osif_addr_read(zb_uint32_t address, zb_uint16_t len, zb_uint8_t* buf)
{
  ...
  do { if ((zb_int_t)0>=(zb_int_t)1 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 1, 51401,194, (0*4 + 1*4 + 1*4 + 0*4 + 0*8), address, len); } while (0)
                                     ;
...
# 211 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
  ...
  do { if ((zb_int_t)0>=(zb_int_t)1 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 1, 51401,227, (1*4 + 2*4 + 0*4 + 0*4 + 0*8), page, pos, len); } while (0)
                                         ;
...
# 229 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
  ...
  memcpy(buf, ((void *)flash_addr), len);
...
# 297 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
  ...
  do { if ((zb_int_t)0>=(zb_int_t)1 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 1, 51401,313, (1*4 + 2*4 + 0*4 + 0*4 + 0*8), page, pos, len); } while (0)
                                         ;
...
# 315 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
  ...
  {if(!((len >= 4) && (len % 4 == 0))) zb_assert(51401, 317);};
...
# 376 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
  ...
  do { if ((zb_int_t)0>=(zb_int_t)3 && ((0x0001) == (zb_uint_t)-1 || (0x0001) & 0) && !0) zb_trace_msg_port(0x0001, 3, 51401,380, (1*4 + 0*4 + 0*4 + 0*4 + 0*8), page); } while (0);
...
static zb_uint_t zb_nvram_buffer_put(zb_uint8_t page, zb_uint32_t pos, void* buf, zb_uint16_t len)
{
  ...
  if (len)
  {
    memcpy(s_nvram_buf.buf + s_nvram_buf.offset, buf, len);
...
zb_bool_t zb_osif_production_configuration_check_header()
{
  ...
  zb_uint8_t hdr[] = {0xE7, 0x37, 0xDD, 0xF6};
  zb_uint8_t buffer[4];

  zb_err_code = zb_osif_addr_read((flash_start_addr() + (
# 479 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c" 3
                                 16384 
# 479 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_nvram.c"
                                 * (
