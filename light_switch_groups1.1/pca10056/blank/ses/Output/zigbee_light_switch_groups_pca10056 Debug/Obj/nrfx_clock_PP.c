...
nrfx_err_t nrfx_clock_init(nrfx_clock_event_handler_t event_handler)
{
    if (1) { if (event_handler) { } else { assert_nrf_callback((uint16_t)160, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"); } };
...
# 175 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_CLOCK_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_CLOCK_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } };
    return err_code;
}

void nrfx_clock_enable(void)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)185, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"); } };
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_CLOCK_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_CLOCK_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Module enabled."); } };
}

void nrfx_clock_disable(void)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)198, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"); } };




    {
        _NRFX_IRQ_DISABLE(nrfx_get_irq_number(((NRF_CLOCK_Type*) 0x40000000UL)));
    }
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_CLOCK_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_CLOCK_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Module disabled."); } };
}

void nrfx_clock_uninit(void)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)221, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"); } };
...
# 224 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"
                                        ;
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_CLOCK_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_CLOCK_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Uninitialized."); } };
}

void nrfx_clock_lfclk_start(void)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)230, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"); } };
...
void nrfx_clock_lfclk_stop(void)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)243, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"); } };
...
void nrfx_clock_hfclk_start(void)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)251, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"); } };
...
void nrfx_clock_hfclk_stop(void)
{
    if (1) { if (m_clock_cb.module_initialized) { } else { assert_nrf_callback((uint16_t)259, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"); } };
...
nrfx_err_t nrfx_clock_calibration_start(void)
{
    nrfx_err_t err_code = ((0x0) + 0);
# 299 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"
    if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (m_nrf_log_CLOCK_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | (((uint32_t)(&m_nrf_log_CLOCK_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
...
void POWER_CLOCK_IRQHandler(void)
{
    ...
    {
        nrf_clock_event_clear(NRF_CLOCK_EVENT_HFCLKSTARTED);
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (m_nrf_log_CLOCK_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(&m_nrf_log_CLOCK_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Event: %s.", (uint32_t)((NRF_CLOCK_EVENT_HFCLKSTARTED == NRF_CLOCK_EVENT_HFCLKSTARTED ? "NRF_CLOCK_EVENT_HFCLKSTARTED" : (NRF_CLOCK_EVENT_HFCLKSTARTED == NRF_CLOCK_EVENT_LFCLKSTARTED ? "NRF_CLOCK_EVENT_LFCLKSTARTED" : (NRF_CLOCK_EVENT_HFCLKSTARTED == NRF_CLOCK_EVENT_DONE ? "NRF_CLOCK_EVENT_DONE" : (NRF_CLOCK_EVENT_HFCLKSTARTED == NRF_CLOCK_EVENT_CTTO ? "NRF_CLOCK_EVENT_CTTO" : "UNKNOWN EVENT")))))); } };
...
# 345 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_clock.c"
    ...
    {
        nrf_clock_event_clear(NRF_CLOCK_EVENT_LFCLKSTARTED);
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (m_nrf_log_CLOCK_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(&m_nrf_log_CLOCK_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Event: %s.", (uint32_t)((NRF_CLOCK_EVENT_LFCLKSTARTED == NRF_CLOCK_EVENT_HFCLKSTARTED ? "NRF_CLOCK_EVENT_HFCLKSTARTED" : (NRF_CLOCK_EVENT_LFCLKSTARTED == NRF_CLOCK_EVENT_LFCLKSTARTED ? "NRF_CLOCK_EVENT_LFCLKSTARTED" : (NRF_CLOCK_EVENT_LFCLKSTARTED == NRF_CLOCK_EVENT_DONE ? "NRF_CLOCK_EVENT_DONE" : (NRF_CLOCK_EVENT_LFCLKSTARTED == NRF_CLOCK_EVENT_CTTO ? "NRF_CLOCK_EVENT_CTTO" : "UNKNOWN EVENT")))))); } };
