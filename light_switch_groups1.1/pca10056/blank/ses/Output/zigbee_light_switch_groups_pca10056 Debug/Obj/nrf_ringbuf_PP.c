# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\ringbuf\\nrf_ringbuf.c"
...
# 57 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\ringbuf\\nrf_ringbuf.c"
                                                                                                          start)
{
    if (1) { if (pp_data) { } else { assert_nrf_callback((uint16_t)59, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\ringbuf\\nrf_ringbuf.c"); } };
    if (1) { if (p_length) { } else { assert_nrf_callback((uint16_t)60, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\ringbuf\\nrf_ringbuf.c"); } };
    ...
    if (p_ringbuf->p_cb->tmp_wr_idx - p_ringbuf->p_cb->rd_idx == p_ringbuf->bufsize_mask + 1)
    {
        *p_length = 0;
        if (start)
        {
            ((void)(nrf_atomic_flag_clear(&p_ringbuf->p_cb->wr_flag)));
        }
        return ((0x0) + 0);
    }
...
ret_code_t nrf_ringbuf_cpy_put(nrf_ringbuf_t const * p_ringbuf,
                               ...
                               size_t * p_length)
{
    if (1) { if (p_data) { } else { assert_nrf_callback((uint16_t)114, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\ringbuf\\nrf_ringbuf.c"); } };
    if (1) { if (p_length) { } else { assert_nrf_callback((uint16_t)115, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\ringbuf\\nrf_ringbuf.c"); } };
...
# 144 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\ringbuf\\nrf_ringbuf.c"
                                                                                                        start)
{
    if (1) { if (pp_data) { } else { assert_nrf_callback((uint16_t)146, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\ringbuf\\nrf_ringbuf.c"); } };
    if (1) { if (p_length) { } else { assert_nrf_callback((uint16_t)147, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\ringbuf\\nrf_ringbuf.c"); } };
    ...
    if (available == 0)
    {
        *p_length = 0;
        if (start)
        {
            ((void)(nrf_atomic_flag_clear(&p_ringbuf->p_cb->rd_flag)));
        }
        return ((0x0) + 0);
    }
...
ret_code_t nrf_ringbuf_cpy_get(nrf_ringbuf_t const * p_ringbuf,
                               ...
                               size_t * p_length)
{
    if (1) { if (p_data) { } else { assert_nrf_callback((uint16_t)193, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\ringbuf\\nrf_ringbuf.c"); } };
    if (1) { if (p_length) { } else { assert_nrf_callback((uint16_t)194, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\components\\libraries\\ringbuf\\nrf_ringbuf.c"); } };
