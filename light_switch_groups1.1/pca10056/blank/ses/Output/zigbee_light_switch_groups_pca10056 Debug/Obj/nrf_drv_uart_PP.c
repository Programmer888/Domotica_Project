...
# 602 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_uart.h" 3 4
       0
# 602 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_uart.h"
       ) { } else { assert_nrf_callback((uint16_t)602, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_uart.h"); } };
    }
    else if ((!(nrf_drv_uart_use_easy_dma[p_instance->inst_idx])))
    {
...
static nrf_uart_event_handler_t m_handlers[2];
static void * m_contexts[2];


uint8_t nrf_drv_uart_use_easy_dma[2];
                             ...
                             nrf_uart_event_handler_t event_handler)
{
    ...
    if (inst_idx == 1)
    {
        if (1) { if (p_config->use_easy_dma) { } else { assert_nrf_callback((uint16_t)118, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_uart.c"); } };
    }
