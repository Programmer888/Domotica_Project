...
# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.h" 1
# 44 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.h"
# 1 "../../../../../../../../modules/nrfx/drivers/include/nrfx_rng.h" 1
# 43 "../../../../../../../../modules/nrfx/drivers/include/nrfx_rng.h"
...
# 44 "../../../../../../../../modules/nrfx/drivers/include/nrfx_rng.h" 2
# 1 "../../../../../../../../modules/nrfx/hal/nrf_rng.h" 1
# 63 "../../../../../../../../modules/nrfx/hal/nrf_rng.h"
typedef enum
{
...
# 118 "../../../../../../../../modules/nrfx/hal/nrf_rng.h"
static inline 
# 118 "../../../../../../../../modules/nrfx/hal/nrf_rng.h" 3 4
               _Bool 
# 118 "../../../../../../../../modules/nrfx/hal/nrf_rng.h"
                    nrf_rng_int_get(nrf_rng_int_mask_t rng_int_mask);
# 127 "../../../../../../../../modules/nrfx/hal/nrf_rng.h"
...
# 143 "../../../../../../../../modules/nrfx/hal/nrf_rng.h"
...
# 160 "../../../../../../../../modules/nrfx/hal/nrf_rng.h"
static inline 
# 160 "../../../../../../../../modules/nrfx/hal/nrf_rng.h" 3 4
               _Bool 
# 160 "../../../../../../../../modules/nrfx/hal/nrf_rng.h"
                    nrf_rng_event_get(nrf_rng_event_t rng_event);
...
static inline 
# 207 "../../../../../../../../modules/nrfx/hal/nrf_rng.h" 3 4
               _Bool 
# 207 "../../../../../../../../modules/nrfx/hal/nrf_rng.h"
                    nrf_rng_int_get(nrf_rng_int_mask_t rng_int_mask)
{
    return (
# 209 "../../../../../../../../modules/nrfx/hal/nrf_rng.h" 3 4
           _Bool
# 209 "../../../../../../../../modules/nrfx/hal/nrf_rng.h"
               )(((NRF_RNG_Type*) 0x4000D000UL)->INTENCLR & rng_int_mask);
}
...
static inline 
# 236 "../../../../../../../../modules/nrfx/hal/nrf_rng.h" 3 4
               _Bool 
# 236 "../../../../../../../../modules/nrfx/hal/nrf_rng.h"
                    nrf_rng_event_get(nrf_rng_event_t rng_event)
{
    return (
# 238 "../../../../../../../../modules/nrfx/hal/nrf_rng.h" 3 4
           _Bool
# 238 "../../../../../../../../modules/nrfx/hal/nrf_rng.h"
               ) * ((volatile uint32_t *)((uint8_t *)((NRF_RNG_Type*) 0x4000D000UL) + rng_event));
}
...
# 45 "../../../../../../../../modules/nrfx/drivers/include/nrfx_rng.h" 2
# 60 "../../../../../../../../modules/nrfx/drivers/include/nrfx_rng.h"
typedef struct
{
    
# 62 "../../../../../../../../modules/nrfx/drivers/include/nrfx_rng.h" 3 4
   _Bool 
# 62 "../../../../../../../../modules/nrfx/drivers/include/nrfx_rng.h"
            error_correction : 1;
    uint8_t interrupt_priority;
} nrfx_rng_config_t;
# 84 "../../../../../../../../modules/nrfx/drivers/include/nrfx_rng.h"
typedef void (* nrfx_rng_evt_handler_t)(uint8_t rng_data);
# 95 "../../../../../../../../modules/nrfx/drivers/include/nrfx_rng.h"
...
extern nrf_log_module_dynamic_data_t m_nrf_log_rng_logs_data_dynamic;
extern const nrf_log_module_const_data_t m_nrf_log_rng_logs_data_const;
...
# 65 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c" 2
const nrf_log_module_const_data_t m_nrf_log_rng_logs_data_const __attribute__ ((section("." "log_const_data_rng"))) __attribute__((used)) = { .p_module_name = "rng", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_dynamic_data_t m_nrf_log_rng_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_rng"))) __attribute__((used)); nrf_log_module_filter_data_t m_nrf_log_rng_logs_data_filter __attribute__ ((section("." "log_filter_data_rng"))) __attribute__((used));
...
static uint8_t m_rand_pool_nrf_queue_buffer[(64) + 1]; static nrf_queue_cb_t m_rand_pool_nrf_queue_cb; const nrf_log_module_const_data_t m_nrf_log_queue_m_rand_pool_logs_data_const __attribute__ ((section("." "log_const_data_queue_m_rand_pool"))) __attribute__((used)) = { .p_module_name = "queue.m_rand_pool", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0 ? 3 : NRF_LOG_SEVERITY_NONE), .initial_lvl = (nrf_log_severity_t)(3), }; nrf_log_module_dynamic_data_t m_nrf_log_queue_m_rand_pool_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_queue_m_rand_pool"))) __attribute__((used)); nrf_log_module_filter_data_t m_nrf_log_queue_m_rand_pool_logs_data_filter __attribute__ ((section("." "log_filter_data_queue_m_rand_pool"))) __attribute__((used)); const nrf_queue_t m_rand_pool __attribute__ ((section("." "nrf_queue"))) __attribute__((used)) = { .p_cb = &m_rand_pool_nrf_queue_cb, .p_buffer = m_rand_pool_nrf_queue_buffer, .size = (64), .element_size = sizeof(uint8_t), .mode = NRF_QUEUE_MODE_OVERFLOW, .p_log = &m_nrf_log_queue_m_rand_pool_logs_data_dynamic, };
static const nrf_drv_rng_config_t m_default_config = { .error_correction = 1, .interrupt_priority = 6, };
# 92 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c"
...
# 95 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c"
    ...
    {
        ((void)(nrf_queue_push(&m_rand_pool, &rng_val)));
        ...
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (m_nrf_log_rng_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(&m_nrf_log_rng_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Event: NRF_RNG_EVENT_VALRDY."); } };
    }
    do { } while (0);
...
void nrf_drv_rng_uninit(void)
{
    if (1) { if (m_rng_cb.state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)144, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c"); } };
...
# 148 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_rng_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_rng_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Uninitialized."); } };
}

void nrf_drv_rng_bytes_available(uint8_t * p_bytes_available)
{
    if (1) { if (m_rng_cb.state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)163, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c"); } };
# 175 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c"
    *p_bytes_available = nrf_queue_utilization_get(&m_rand_pool);

    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_rng_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_rng_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, available bytes: %d.", (uint32_t)((uint32_t)__func__), (uint32_t)(*p_bytes_available)); } };
}

ret_code_t nrf_drv_rng_rand(uint8_t * p_buff, uint8_t length)
{
    ret_code_t err_code = ((0x0) + 0);
    if (1) { if (m_rng_cb.state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)183, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c"); } };
# 192 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c"
        {
...
# 209 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c"
    if (1) { if ((err_code == ((0x0) + 0)) || (err_code == ((0x0) + 5))) { } else { assert_nrf_callback((uint16_t)209, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c"); } };





    if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (m_nrf_log_rng_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | (((uint32_t)(&m_nrf_log_rng_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, error code: %s.", (uint32_t)((uint32_t)__func__), (uint32_t)((uint32_t)nrf_strerror_get(err_code))); } }
...
void nrf_drv_rng_block_rand(uint8_t * p_buff, uint32_t length)
{
    if (1) { if (m_rng_cb.state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)224, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\integration\\nrfx\\legacy\\nrf_drv_rng.c"); } };

    while (length)
    {
        uint32_t len = ((length) < (64) ? (length) : (64));
        ret_code_t err_code;
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (m_nrf_log_rng_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(&m_nrf_log_rng_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Rand buffer data:"); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (m_nrf_log_rng_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_hexdump((((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(&m_nrf_log_rng_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16)), (((uint8_t *)p_buff)), ((length))); } };
}
