# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_ota_upgrade_addons.c"
...
# 42 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_ota_upgrade_addons.c" 2
# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_ota_upgrade_addons.h" 1
# 45 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_ota_upgrade_addons.h"
# 1 "../config/sdk_config.h" 1
# 46 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_ota_upgrade_addons.h" 2
...
static void ota_server_discovery_handler(void * p_ctx)
{
    ...
    {if(!(attr_desc)) zb_assert(0, 56);};

    if ((!memcmp((attr_desc->data_p), (void const*)g_unknown_ieee_addr, 8)))
    {

        ((void)(zb_get_out_buf_delayed(zb_zcl_ota_upgrade_init_client)));
    }
    else
    {

        ((void)(zb_zcl_ota_upgrade_client_periodical_discovery_stop(p_context)));
    }
}
...
{
    do { if (!((p_context != 
# 72 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_ota_upgrade_addons.c" 3 4
   0
# 72 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_ota_upgrade_addons.c"
   ))) { return ((0x0) + 7); } } while (0);
    do { if (!((p_timer_id != 
# 73 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_ota_upgrade_addons.c" 3 4
   0
# 73 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_ota_upgrade_addons.c"
...
# 86 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_ota_upgrade_addons.c"
    ...
    err_code = app_timer_start(*(p_context->p_timer_id), ((uint32_t)(((((5 * 60) * 1000) * (uint64_t)32768) + ((1000 * (0 + 1)) / 2)) / (1000 * (0 + 1)))), p_context);
    if (err_code != ((0x0) + 0))
    {
        return err_code;
    }
