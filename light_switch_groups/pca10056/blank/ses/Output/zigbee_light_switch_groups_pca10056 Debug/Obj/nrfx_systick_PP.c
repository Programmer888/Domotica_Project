...
# 1 "../../../../../../../../modules/nrfx/drivers/include/nrfx_systick.h" 1
# 45 "../../../../../../../../modules/nrfx/drivers/include/nrfx_systick.h"
# 1 "../../../../../../../../modules/nrfx/hal/nrf_systick.h" 1
# 75 "../../../../../../../../modules/nrfx/hal/nrf_systick.h"
typedef enum {
    NRF_SYSTICK_CSR_COUNTFLAG_MASK = (1UL << 16U),

    NRF_SYSTICK_CSR_CLKSOURCE_MASK = (1UL << 2U),
    NRF_SYSTICK_CSR_CLKSOURCE_REF = 0U << 2U,
    NRF_SYSTICK_CSR_CLKSOURCE_CPU = 1U << 2U,

    NRF_SYSTICK_CSR_TICKINT_MASK = (1UL << 1U),
    NRF_SYSTICK_CSR_TICKINT_ENABLE = 1U << 1U,
    NRF_SYSTICK_CSR_TICKINT_DISABLE = 0U << 1U,

    NRF_SYSTICK_CSR_ENABLE_MASK = (1UL ),
    NRF_SYSTICK_CSR_ENABLE = 1U << 0U,
    NRF_SYSTICK_CSR_DISABLE = 0U << 0U
...
static inline uint32_t nrf_systick_csr_get(void);
...
static inline void nrf_systick_csr_set(uint32_t val);
...
static inline uint32_t nrf_systick_load_get(void);
...
static inline void nrf_systick_load_set(uint32_t val);
...
static inline uint32_t nrf_systick_val_get(void);
...
static inline void nrf_systick_val_clear(void);
...
static inline uint32_t nrf_systick_calib_get(void);
...
static inline uint32_t nrf_systick_csr_get(void)
{
    return ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL;
}

static inline void nrf_systick_csr_set(uint32_t val)
{
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL = val;
}

static inline uint32_t nrf_systick_load_get(void)
{
    return ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD;
}

static inline void nrf_systick_load_set(uint32_t val)
{
    ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->LOAD = val;
}
...
static inline uint32_t nrf_systick_calib_get(void)
{
    return ((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CALIB;
}
# 46 "../../../../../../../../modules/nrfx/drivers/include/nrfx_systick.h" 2
# 74 "../../../../../../../../modules/nrfx/drivers/include/nrfx_systick.h"
typedef struct {
    uint32_t time;
...
# 93 "../../../../../../../../modules/nrfx/drivers/include/nrfx_systick.h"
void nrfx_systick_get(nrfx_systick_state_t * p_state);
# 104 "../../../../../../../../modules/nrfx/drivers/include/nrfx_systick.h"

# 104 "../../../../../../../../modules/nrfx/drivers/include/nrfx_systick.h" 3 4
_Bool 
# 104 "../../../../../../../../modules/nrfx/drivers/include/nrfx_systick.h"
    nrfx_systick_test(nrfx_systick_state_t const * p_state, uint32_t us);
...
# 127 "../../../../../../../../modules/nrfx/drivers/include/nrfx_systick.h"
void nrfx_systick_delay_ms(uint32_t ms);
# 44 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_systick.c" 2
# 99 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_systick.c"
static inline uint32_t nrfx_systick_us_tick(uint32_t us)
{
    return us * ((SystemCoreClock) / (1000UL * (1000UL)));
}
# 115 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_systick.c"
static inline uint32_t nrfx_systick_ms_tick(uint32_t ms)
{
    return ms * ((SystemCoreClock) / (1000UL));
}

void nrfx_systick_init(void)
{
    nrf_systick_load_set((0xFFFFFFUL ));
    nrf_systick_csr_set(
...
# 134 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_systick.c"
    nrfx_systick_test(nrfx_systick_state_t const * p_state, uint32_t us)
{
    if (1) { if (us <= (((0xFFFFFFUL ) / 2UL) / ((SystemCoreClock) / (1000UL * (1000UL))))) { } else { assert_nrf_callback((uint16_t)136, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_systick.c"); } };;

    const uint32_t diff = (0xFFFFFFUL ) & ((p_state->time) - nrf_systick_val_get());
    return (diff >= nrfx_systick_us_tick(us));
}

void nrfx_systick_delay_ticks(uint32_t ticks)
{
    if (1) { if (ticks <= ((0xFFFFFFUL ) / 2UL)) { } else { assert_nrf_callback((uint16_t)144, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_systick.c"); } };

    const uint32_t start = nrf_systick_val_get();
    while (((0xFFFFFFUL ) & (start - nrf_systick_val_get())) < ticks)
    {
...
void nrfx_systick_delay_us(uint32_t us)
{
    if (1) { if (us <= (((0xFFFFFFUL ) / 2UL) / ((SystemCoreClock) / (1000UL * (1000UL))))) { } else { assert_nrf_callback((uint16_t)155, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_systick.c"); } };;
...
void nrfx_systick_delay_ms(uint32_t ms)
{
    ...
    while (0 != (n--))
    {
        nrfx_systick_delay_ticks(nrfx_systick_ms_tick((64U)));
    }
