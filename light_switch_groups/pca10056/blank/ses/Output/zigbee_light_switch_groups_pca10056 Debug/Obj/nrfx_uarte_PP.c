...
static inline 
# 475 "../../../../../../../../modules/nrfx/hal/nrf_uarte.h" 3 4
               _Bool 
...
static inline 
# 501 "../../../../../../../../modules/nrfx/hal/nrf_uarte.h" 3 4
               _Bool 
...
extern nrf_log_module_dynamic_data_t m_nrf_log_UARTE_logs_data_dynamic;
extern const nrf_log_module_const_data_t m_nrf_log_UARTE_logs_data_const;
...
const nrf_log_module_const_data_t m_nrf_log_UARTE_logs_data_const __attribute__ ((section("." "log_const_data_UARTE"))) __attribute__((used)) = { .p_module_name = "UARTE", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_dynamic_data_t m_nrf_log_UARTE_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_UARTE"))) __attribute__((used)); nrf_log_module_filter_data_t m_nrf_log_UARTE_logs_data_filter __attribute__ ((section("." "log_filter_data_UARTE"))) __attribute__((used));
# 58 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c" 2
# 98 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"
typedef struct
{
...
nrfx_err_t nrfx_uarte_init(nrfx_uarte_t const * p_instance,
                           ...
                           nrfx_uarte_event_handler_t event_handler)
{
    if (1) { if (p_config) { } else { assert_nrf_callback((uint16_t)205, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    ...
    {
        err_code = ((0x0) + 8);
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (m_nrf_log_UARTE_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | (((uint32_t)(&m_nrf_log_UARTE_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
...
# 283 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"
                       ;
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UARTE_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UARTE_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Instance uninitialized: %d.", (uint32_t)(p_instance->drv_inst_idx)); } };
}
...
{
    uarte_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (1) { if (p_cb->state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)292, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (p_data) { } else { assert_nrf_callback((uint16_t)293, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (length > 0) { } else { assert_nrf_callback((uint16_t)294, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (((((p_instance->drv_inst_idx) == NRFX_UARTE0_INST_IDX) && (((length) < (1U << 16)) && ((0) < (1U << 16)))) || 0 || 0 || 0)) { } else { assert_nrf_callback((uint16_t)295, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UARTE_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UARTE_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Transfer tx_len: %d.", (uint32_t)(p_cb->tx_buffer_length)); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (m_nrf_log_UARTE_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(&m_nrf_log_UARTE_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Tx data:"); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (m_nrf_log_UARTE_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_hexdump((((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(&m_nrf_log_UARTE_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16)), ((p_cb->p_tx_buffer)), ((p_cb->tx_buffer_length * sizeof(p_cb->p_tx_buffer[0])))); } }
                                                                                 ;
...
# 336 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UARTE_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UARTE_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } };
    return err_code;
}
                         ...
                         size_t length)
{
    ...
    if (1) { if (m_cb[p_instance->drv_inst_idx].state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)366, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (p_data) { } else { assert_nrf_callback((uint16_t)367, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (length > 0) { } else { assert_nrf_callback((uint16_t)368, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
    if (1) { if (((((p_instance->drv_inst_idx) == NRFX_UARTE0_INST_IDX) && (((length) < (1U << 16)) && ((0) < (1U << 16)))) || 0 || 0 || 0)) { } else { assert_nrf_callback((uint16_t)369, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"); } };
...
# 406 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UARTE_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UARTE_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Transfer rx_len: %d.", (uint32_t)(length)); } };
...
# 513 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uarte.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UARTE_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UARTE_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "TX transaction aborted."); } };
}
...
void nrfx_uarte_rx_abort(nrfx_uarte_t const * p_instance)
{
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UARTE_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UARTE_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "RX transaction aborted."); } };
}
