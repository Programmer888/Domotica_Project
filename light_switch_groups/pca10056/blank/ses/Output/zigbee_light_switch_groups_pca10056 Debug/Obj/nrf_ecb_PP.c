...
typedef enum
{
    ...
    NRF_ECB_TASK_STARTECB = __builtin_offsetof (NRF_ECB_Type, TASKS_STARTECB),
    NRF_ECB_TASK_STOPECB = __builtin_offsetof (NRF_ECB_Type, TASKS_STOPECB),
...
typedef enum
{
    ...
    NRF_ECB_EVENT_ENDECB = __builtin_offsetof (NRF_ECB_Type, EVENTS_ENDECB),
    NRF_ECB_EVENT_ERRORECB = __builtin_offsetof (NRF_ECB_Type, EVENTS_ERRORECB),
    ...
    nrf_ecb_init(void)
{
  ...
  ((NRF_ECB_Type*) 0x4000E000UL)->ECBDATAPTR = (uint32_t)ecb_data;
  return 
# 59 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\hal\\nrf_ecb.c" 3 4
        1
# 59 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\hal\\nrf_ecb.c"
...
_Bool 
# 63 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\hal\\nrf_ecb.c"
    nrf_ecb_crypt(uint8_t * dest_buf, const uint8_t * src_buf)
{
   ...
   ((NRF_ECB_Type*) 0x4000E000UL)->TASKS_STARTECB = 1;
