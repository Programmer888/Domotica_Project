...
extern const nrf_log_module_const_data_t m_nrf_log_UART_logs_data_const;
...
const nrf_log_module_const_data_t m_nrf_log_UART_logs_data_const __attribute__ ((section("." "log_const_data_UART"))) __attribute__((used)) = { .p_module_name = "UART", .info_color_id = (0), .debug_color_id = (0), .compiled_lvl = (nrf_log_severity_t)(0), .initial_lvl = (nrf_log_severity_t)(0), }; nrf_log_module_dynamic_data_t m_nrf_log_UART_logs_data_dynamic __attribute__ ((section("." "log_dynamic_data_UART"))) __attribute__((used)); nrf_log_module_filter_data_t m_nrf_log_UART_logs_data_filter __attribute__ ((section("." "log_filter_data_UART"))) __attribute__((used));
# 55 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uart.c" 2
# 63 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
typedef struct
{
                          ...
                          nrfx_uart_event_handler_t event_handler)
{
    ...
    {
        err_code = ((0x0) + 8);
        if (1 && (0 >= NRF_LOG_SEVERITY_WARNING) && (NRF_LOG_SEVERITY_WARNING <= 3)) { if (m_nrf_log_UART_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_WARNING) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_WARNING) | (((uint32_t)(&m_nrf_log_UART_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } }
...
# 240 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
                       ;
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UART_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UART_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Instance uninitialized: %d.", (uint32_t)(p_instance->drv_inst_idx)); } };
}
...
# 294 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UART_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UART_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Transfer tx_len: %d.", (uint32_t)(p_cb->tx_buffer_length)); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (m_nrf_log_UART_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(&m_nrf_log_UART_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Tx data:"); } };
    if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (m_nrf_log_UART_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_hexdump((((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(&m_nrf_log_UART_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16)), ((p_cb->p_tx_buffer)), ((p_cb->tx_buffer_length * sizeof(p_cb->p_tx_buffer[0])))); } }
                                                                                 ;
...
# 308 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UART_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_2(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UART_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Function: %s, error code: %s.", (uint32_t)(__func__), (uint32_t)(nrf_strerror_get(err_code))); } };
    return err_code;
}
...
# 389 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UART_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UART_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Transfer rx_len: %d.", (uint32_t)(length)); } };
...
# 531 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_uart.c"
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UART_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UART_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "TX transaction aborted."); } };
}
...
void nrfx_uart_rx_abort(nrfx_uart_t const * p_instance)
{
    ...
    if (1 && (0 >= NRF_LOG_SEVERITY_INFO) && (NRF_LOG_SEVERITY_INFO <= 3)) { if (m_nrf_log_UART_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_INFO) { nrf_log_frontend_std_0(((NRF_LOG_SEVERITY_INFO) | (((uint32_t)(&m_nrf_log_UART_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "RX transaction aborted."); } };
}
                             ...
                             uart_control_block_t * p_cb)
{
        ...
        nrf_uart_event_check(p_uart, NRF_UART_EVENT_ERROR))
    {
        ...
        if (1 && (0 >= NRF_LOG_SEVERITY_DEBUG) && (NRF_LOG_SEVERITY_DEBUG <= 3)) { if (m_nrf_log_UART_logs_data_dynamic.filter >= NRF_LOG_SEVERITY_DEBUG) { nrf_log_frontend_std_1(((NRF_LOG_SEVERITY_DEBUG) | (((uint32_t)(&m_nrf_log_UART_logs_data_const) - (uint32_t)&__start_log_const_data) / sizeof(nrf_log_module_const_data_t)) << 16), "Event: %s.", (uint32_t)((NRF_UART_EVENT_ERROR == NRF_UART_EVENT_ERROR ? "NRF_UART_EVENT_ERROR" : "UNKNOWN EVENT"))); } };
