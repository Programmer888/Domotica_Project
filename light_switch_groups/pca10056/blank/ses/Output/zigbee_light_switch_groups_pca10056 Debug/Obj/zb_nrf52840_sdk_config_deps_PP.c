# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_sdk_config_deps.c"
...
__extension__ _Static_assert(21452 < 65535, "Assert at line __LINE__");
...
# 44 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_sdk_config_deps.c" 2
...
# 234 "../../../../../../../../modules/nrfx/hal/nrf_rtc.h"
...
# 351 "../../../../../../../../modules/nrfx/hal/nrf_rtc.h"
static inline uint32_t nrf_rtc_event_pending(NRF_RTC_Type * p_reg, nrf_rtc_event_t event)
{
...
static inline void nrf_rtc_prescaler_set(NRF_RTC_Type * p_reg, uint32_t val)
{
    if (1) { if (val <= ((0xFFFUL << (0UL)) >> (0UL))) { } else { assert_nrf_callback((uint16_t)372, (uint8_t *)"../../../../../../../../modules/nrfx/hal/nrf_rtc.h"); } };
    p_reg->PRESCALER = val;
}
...
enum {
# 100 "../../../../../../../../modules/nrfx/drivers/include/nrfx_rtc.h"
...
# 282 "../../../../../../../../integration/nrfx/legacy/nrf_drv_clock.h"
static inline uint32_t nrf_drv_clock_ppi_task_addr(nrf_clock_task_t task)
{
    return nrf_clock_task_address_get(task);
}
...
# 61 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_sdk_config_deps.c" 2
# 80 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_sdk_config_deps.c"
static const nrf_drv_timer_t gs_zboss_timer = { .p_reg = ((NRF_TIMER_Type*) 0x4001A000UL), .instance_id = NRFX_TIMER3_INST_IDX, .cc_channel_count = 6, };
...
nrf_drv_timer_config_t zb_nrf_cfg_get_timer_default_config(void)
{
  nrf_drv_timer_config_t c =
  {
    ...
    .p_context = 
# 96 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\osif\\zb_nrf52840_sdk_config_deps.c" 3 4
                         0
