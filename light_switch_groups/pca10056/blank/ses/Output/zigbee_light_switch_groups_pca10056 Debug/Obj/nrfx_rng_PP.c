...
# 44 "../../../../../../../../modules/nrfx/drivers/include/nrfx_rng.h"
...
nrfx_err_t nrfx_rng_init(nrfx_rng_config_t const * p_config, nrfx_rng_evt_handler_t handler)
{
    if (1) { if (p_config) { } else { assert_nrf_callback((uint16_t)62, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_rng.c"); } };
    if (1) { if (handler) { } else { assert_nrf_callback((uint16_t)63, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_rng.c"); } };
    ...
    _NRFX_IRQ_PRIORITY_SET(RNG_IRQn, p_config->interrupt_priority);
    _NRFX_IRQ_ENABLE(RNG_IRQn);
...
void nrfx_rng_start(void)
{
    if (1) { if (m_rng_state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)86, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_rng.c"); } };
...
void nrfx_rng_stop(void)
{
    if (1) { if (m_rng_state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)94, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_rng.c"); } };
...
void nrfx_rng_uninit(void)
{
    if (1) { if (m_rng_state == NRFX_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)101, (uint8_t *)"C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\modules\\nrfx\\drivers\\src\\nrfx_rng.c"); } };

    nrf_rng_int_disable(NRF_RNG_INT_VALRDY_MASK);
    nrf_rng_task_trigger(NRF_RNG_TASK_STOP);
    _NRFX_IRQ_DISABLE(RNG_IRQn);
