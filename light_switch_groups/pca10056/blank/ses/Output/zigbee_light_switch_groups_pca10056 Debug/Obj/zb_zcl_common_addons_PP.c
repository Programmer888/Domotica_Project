# 1 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_common_addons.c"
...
# 42 "C:\\nRF5_SDK_for_Thread_and_Zigbee_v3.2.0_9fade31\\external\\zboss\\addons\\zcl\\zb_zcl_common_addons.c" 2
                                   ...
                                   zb_callback_t p_cb)
{
    ...
    (p_cmd_ptr) = zb_buf_smart_alloc_left((p_buf), (((p_cmd_ptr) - ((p_buf)->buf))));

    switch (dst_addr_mode)
    {
        case ZB_APS_ADDR_MODE_DST_ADDR_ENDP_NOT_PRESENT:
            remote_addr_short = (zb_uint16_t)(-1);
            break;
        ...
        case ZB_APS_ADDR_MODE_64_ENDP_PRESENT:
            {
                ...
                if (remote_addr_short == (zb_uint16_t)(-1))
                {
    ...
    zb_zcl_send_command_short_without_ack(p_buf, remote_addr_short, dst_addr_mode, dst_ep, src_ep, profile_id, cluster_id, p_cb, 0)
